...
function LoadJSCode(e, t) {
    if (!Math.fround) {
        ...
        }, o = ["EMSCRIPTEN_START_ASM", "EMSCRIPTEN_START_FUNCS", "EMSCRIPTEN_END_FUNCS"], i = "var", r = "global.Math.fround;", a = 0, s = n.LOOKING_FOR_MODULE, d = 0, l = 0; s <= n.SCANNING_MODULE_FUNCTIONS && a < e.length; a++)
            if (47 == e[a] && 47 == e[a + 1] && 32 == e[a + 2] && String.fromCharCode.apply(null, e.subarray(a + 3, a + 3 + o[s].length)) === o[s]) s++;
            else if (s != n.SCANNING_MODULE_VARIABLES || l || 61 != e[a] || String.fromCharCode.apply(null, e.subarray(a + 1, a + 1 + r.length)) !== r) {
                if (l && 40 == e[a]) {
        ...
        return function e(t, n, o) {
            ...
            2: [function(e, t, n) {
                ...
                d[254] = d[254] = 1, n.string2buf = function(e) {
                    ...
                    var n, i, r, a, s = t || e.length,
                        l = new Array(2 * s);
                    for (i = 0, n = 0; s > n;)
                        if (r = e[n++], 128 > r) l[i++] = r;
                        else if (a = d[r], a > 4) l[i++] = 65533, n += a - 1;
                        else {
            ...
            7: [function(e, t, n) {
                ...
                t.exports = function(e, t) {
                    var n, r, a, s, d, l, u, c, f, h, p, m, w, b, g, v, k, y, _, S, x, M, C, E, D;
                    n = e.state, r = e.next_in, E = e.input, a = r + (e.avail_in - 5), s = e.next_out, D = e.output, d = s - (t - e.avail_out), l = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, w = n.bits, b = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                    e: do {
                        15 > w && (m += E[r++] << w, w += 8, m += E[r++] << w, w += 8), y = b[m & v];
                        t: for (;;) {
                            if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _) D[s++] = 65535 & y;
                                ...
                                S = 65535 & y, _ &= 15, _ && (_ > w && (m += E[r++] << w, w += 8), S += m & (1 << _) - 1, m >>>= _, w -= _), 15 > w && (m += E[r++] << w, w += 8, m += E[r++] << w, w += 8), y = g[m & k];
                                n: for (;;) {
                                    ...
                                    if (x = 65535 & y, _ &= 15, _ > w && (m += E[r++] << w, w += 8, _ > w && (m += E[r++] << w, w += 8)), x += m & (1 << _) - 1, x > u) {
                    ...
                    S = w >> 3, r -= S, w -= S << 3, m &= (1 << w) - 1, e.next_in = r, e.next_out = s, e.avail_in = a > r ? 5 + (a - r) : 5 - (r - a), e.avail_out = l > s ? 257 + (l - s) : 257 - (s - l), n.hold = m, n.bits = w
                }
            }, {}],
            8: [function(e, t, n) {
                "use strict";
                ...
                function r(e) {
                    var t;
                    return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = U, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new b.Buf32(pe), t.distcode = t.distdyn = new b.Buf32(me), t.sane = 1, t.back = -1, D) : I
                }

                function a(e) {
                    var t;
                    return e && e.state ? (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, r(e)) : I
                }

                function s(e, t) {
                    var n, o;
                    return e && e.state ? (o = e.state, 0 > t ? (n = 0, t = -t) : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15) ? I : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, a(e))) : I
                }

                function d(e, t) {
                    var n, o;
                    return e ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== D && (e.state = null), n) : I
                }
                ...
                function c(e, t, n, o) {
                    var i, r = e.state;
                    return null === r.window && (r.wsize = 1 << r.wbits, r.wnext = 0, r.whave = 0, r.window = new b.Buf8(r.wsize)), o >= r.wsize ? (b.arraySet(r.window, t, n - r.wsize, r.wsize, 0), r.wnext = 0, r.whave = r.wsize) : (i = r.wsize - r.wnext, i > o && (i = o), b.arraySet(r.window, t, n - o, i, r.wnext), o -= i, o ? (b.arraySet(r.window, t, n - o, o, 0), r.wnext = o, r.whave = r.wsize) : (r.wnext += i, r.wnext === r.wsize && (r.wnext = 0), r.whave < r.wsize && (r.whave += i))), 0
                }

                function f(e, t) {
                    var n, i, r, a, s, d, l, f, h, p, m, w, pe, me, we, be, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0,
                        Ee = new b.Buf8(4),
                        De = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                    if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return I;
                    n = e.state, n.mode === W && (n.mode = K), s = e.next_out, r = e.output, l = e.avail_out, a = e.next_in, i = e.input, d = e.avail_in, f = n.hold, h = n.bits, p = d, m = l, Se = D;
                    e: for (;;) switch (n.mode) {
                        case U:
                            if (0 === n.wrap) {
                                n.mode = K;
                            ...
                            n.dmax = 1 << _e, e.adler = n.check = 1, n.mode = 512 & f ? H : W, f = 0, h = 0;
                            break;
                        case N:
                            for (; 16 > h;) {
                                if (0 === d) break e;
                        ...
                        case P:
                            ...
                            n.mode = Z;
                        case Z:
                            if (1024 & n.flags && (w = n.length, w > d && (w = d), w && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, i, a, w, _e)), 512 & n.flags && (n.check = v(n.check, i, w, a)), d -= w, a += w, n.length -= w), n.length)) break e;
                            n.length = 0, n.mode = q;
                        case q:
                            if (2048 & n.flags) {
                                if (0 === d) break e;
                                w = 0;
                                do _e = i[a + w++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && d > w);
                                if (512 & n.flags && (n.check = v(n.check, i, w, a)), d -= w, a += w, _e) break e
                        ...
                        case G:
                            if (4096 & n.flags) {
                                if (0 === d) break e;
                                w = 0;
                                do _e = i[a + w++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && d > w);
                                if (512 & n.flags && (n.check = v(n.check, i, w, a)), d -= w, a += w, _e) break e
                        ...
                        case V:
                            if (w = n.length) {
                                ...
                                b.arraySet(r, i, a, w, s), d -= w, a += w, l -= w, s += w, n.length -= w;
                                break
                            }
                            n.mode = W;
                            break;
                        ...
                        case ne:
                            if (d >= 6 && l >= 258) {
                                e.next_out = s, e.avail_out = l, e.next_in = a, e.avail_in = d, n.hold = f, n.bits = h, k(e, m), s = e.next_out, r = e.output, l = e.avail_out, a = e.next_in, i = e.input, d = e.avail_in, f = n.hold, h = n.bits, n.mode === W && (n.back = -1);
                                break
                            }
                        ...
                        case ie:
                            ...
                            n.offset = ge, n.extra = 15 & be, n.mode = re;
                        case re:
                            if (n.extra) {
                                for (Me = n.extra; Me > h;) {
                                    if (0 === d) break e;
                        ...
                        case ae:
                            ...
                            } else me = r, pe = s - n.offset, w = n.length;
                            w > l && (w = l), l -= w, n.length -= w;
                            do r[s++] = me[pe++]; while (--w);
                    ...
                    return e.next_out = s, e.avail_out = l, e.next_in = a, e.avail_in = d, n.hold = f, n.bits = h, (n.wsize || m !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = fe, L) : (p -= e.avail_in, m -= e.avail_out, e.total_in += p, e.total_out += m, n.total += m, n.wrap && m && (e.adler = n.check = n.flags ? v(n.check, r, m, e.next_out - m) : g(n.check, r, m, e.next_out - m)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === W ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === p && 0 === m || t === M) && Se === D && (Se = F), Se)
                }
            ...
            9: [function(e, t, n) {
                ...
                t.exports = function(e, t, n, p, m, w, b, g) {
                    ...
                    for (L = D, B = i; B >= 1 && 0 === Z[B]; B--);
                    if (L > B && (L = B), 0 === B) return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
                    for (I = 1; B > I && 0 === Z[I]; I++);
                    for (I > L && (L = I), U = 1, R = 1; i >= R; R++)
                        if (U <<= 1, U -= Z[R], 0 > U) return -1;
                    if (U > 0 && (e === s || 1 !== B)) return -1;
                    for (q[1] = 0, R = 1; i > R; R++) q[R + 1] = q[R] + Z[R];
                    for (A = 0; p > A; A++) 0 !== t[n + A] && (b[q[t[n + A]]++] = A);
                    if (e === s ? (T = G = b, x = 19) : e === d ? (T = u, P -= 257, G = c, j -= 257, x = 256) : (T = f, G = h, x = -1), z = 0, A = 0, R = I, S = w, F = L, O = 0, y = -1, N = 1 << L, _ = N - 1, e === d && N > r || e === l && N > a) return 1;
                    for (var H = 0;;) {
                        H++, M = R - O, b[A] < x ? (C = 0, E = b[A]) : b[A] > x ? (C = G[j + b[A]], E = T[P + b[A]]) : (C = 96, E = 0), v = 1 << R - O, k = 1 << F, I = k;
                        ...
                        if (R > L && (z & _) !== y) {
                            for (0 === O && (O = L), S += I, F = R - O, U = 1 << F; B > F + O && (U -= Z[F + O], !(0 >= U));) F++, U <<= 1;
                            if (N += 1 << F, e === d && N > r || e === l && N > a) return 1;
                            y = z & _, m[y] = L << 24 | F << 16 | S - w | 0
                        }
                    }
                    return 0 !== z && (m[S + z] = R - O << 24 | 64 << 16 | 0), g.bits = L, 0
                }
            }, {
                "../utils/common": 1
            }],
    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                }, new n(0, 109128, 0, 0).open("GET", "/data.unity3d"), new n(109128, 109275, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new n(109275, 112291, 0, 0).open("GET", "/preserved_derived_types.xml"), new n(112291, 1984567, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new n(1984567, 2859539, 0, 0).open("GET", "/Resources/unity_default_resources"), new n(2859539, 2887164, 0, 0).open("GET", "/Managed/mono/2.0/machine.config");
                var p = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB,
                    ...
                    v = "METADATA",
                    k = "PACKAGES";
                Module.addRunDependency("datafile_BetMineBuild.data"), Module.preloadResults || (Module.preloadResults = {}), r(function(e) {
                    l(e, o + i, function(t) {
                        Module.preloadResults[i] = {
                            fromCache: t
                        }, t ? (console.info("loading " + i + " from cache"), u(e, o + i, f, h)) : (console.info("loading " + i + " from remote"), fetchRemotePackageWrapper(a, s, function(t) {
                            c(e, o + i, t, {
                                uuid: d
                            }, f, function(e) {
                                console.error(e), f(t)
            ...
            var a = "function" == typeof Module.locateFile ? Module.locateFile(r) : (Module.filePackagePrefixURL || "") + r,
                s = 2887164,
                d = "7370e5fa-ac2c-4207-942c-8e557f103906";
