 ...
 */
return [
    "start_game" => "Chơi game",
    "your_account" =>"Tài khoản",
    ...
    "top_player" => "Top 5 người chơi trong ngày",
    "h_player_list" => '<span class="wl">Người chơi </span>Tên',
    "h_amount_bet" => '<span class="wl">Số tiền </span>Cược',
    "h_amount_won" => '<span class="wl">Số tiền </span>Thắng',
    "h_total_win" =>  'Tổng <span class="wl"> thắng </span>',
    "top_player_week" => "Top 10 chiến thắng tuần trước",
    "top_week_board" => "Bảng",
    "top_week_player" => "Người chơi",
    "top_week_bet" => "Cược",
