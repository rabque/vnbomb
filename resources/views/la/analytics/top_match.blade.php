...
@section("contentheader_title", "Ván thắng nhiều nhất")
@section("contentheader_description", "")
@section("section", "Ván thắng nhiều nhất")
@section("sub_section", "Listing")
@section("htmlheader_title", "Ván thắng nhiều nhất")
...
@section("main-content")
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <form class="form-inline" method="post" action="{{ url(config('laraadmin.adminRoute') . '/analytics/top_match') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
    ...
    <div class="box box-success">
        ...
        <div class="box-footer">
            {{ $topWinMatch->appends($params)->links() }}
        </div>
    </div>
